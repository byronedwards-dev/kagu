...
export const IMAGE_MODELS = [
  {
    ...
    description: "Rich lighting, character feel, cinematic",
  ...
  },
  {
    ...
    name: "Ideogram V2A",
    provider: "Ideogram",
    description: "Good text rendering, creative style",
    best_for: "Experimental, stylized looks",
    cost: "~$0.04/image",
  },
  {
    id: "ideogram-quality",
    name: "Ideogram Quality",
    provider: "Ideogram",
