...
export const CLAUDE_MODELS = [
  { id: "claude-sonnet-4-20250514", label: "Sonnet 4.5", description: "Fast, good quality" },
  { id: "claude-opus-4-20250514", label: "Opus 4.6", description: "Best quality, slower" },
];

export async function callClaude(messages, systemPrompt, signal, model) {
...
export async function generateImage({ model, prompt, aspectRatio, signal }) {
  const routeMap = {
    ...
    "gpt-image-1": "/api/generate-openai",
    "gpt-image-1.5": "/api/generate-openai",
  };
...
export const IMAGE_MODELS = [
  ...
  },
  {
    ...
    provider: "OpenAI",
    tier: "balance",
    best_for: "Accurate text, complex prompts",
    cost: "~$0.07/image",
  },
  {
    id: "ideogram",
  ...
  },
  {
    ...
    provider: "OpenAI",
    tier: "quality",
    best_for: "Best prompt adherence, photorealistic",
    cost: "~$0.19/image",
  },
  {
    id: "ideogram-quality",
