...
- NEVER mention hair color, eye color, or skin color in story text — appearance details belong only in image prompts, not narration`,
...
- Faces must NOT be directly touching other faces or objects — maintain clear separation between faces for reliable face detection and swap
...
- NO visible text, lettering, words, signs, labels, or typography in any image — image gen models render text poorly and it looks broken
...
5. User can override any individual default during clarification`,
  ...
  qualityChecklist: [
    ...
    "No visible text/lettering/signs described in image prompts",
    "Faces not directly touching other faces or objects",
    "Story text never mentions hair color, eye color, or skin color",
